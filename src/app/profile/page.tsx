  ...
  return (
    <>
      ...
      <div className='flex flex-col w-10/12 max-w-4xl py-2'>
        <Text size='5' weight='bold' className='text-gray-900'>참여 중 스터디</Text>
        <Text size='2' weight='medium' className='text-gray-400 pb-3'>3개의 스터디가 진행중입니다.</Text>
        <StudyCardContainer />
      </div>
      <div className='flex flex-col w-10/12 max-w-4xl py-2'>
        <Text size='5' weight='bold' className='text-gray-900'>수료한 스터디</Text>
        <Text size='2' weight='medium' className='text-gray-400 pb-3'>3개의 스터디를 수료했습니다.</Text>
